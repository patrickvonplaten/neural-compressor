...
def main():
    ...
    if model_args.benchmark:
        ...
        if model_args.mode == 'performance':
            ...
            eval_dataset = SQuADDataset(eval_dataset, model, label_names=["start_positions", "end_positions"])
            conf = BenchmarkConfig(iteration=100,
                                   cores_per_instance=28,
                                   num_of_instance=1)
            b_dataloader = DefaultDataLoader(eval_dataset, model_args.batch_size)
