...
from .st_utils.tuning_sampler import OpTypeWiseTuningSampler, FallbackTuningSampler, ModelWiseTuningSampler, RecipeTuningSampler
...
class BasicTuneStrategy(TuneStrategy):
    ...
    def next_tune_cfg(self):
        ...
        for calib_sampling_size in calib_sampling_size_lst:
            ...
            recipe_sampler = RecipeTuningSampler(tuning_space, [], deepcopy(self.cur_best_tuning_cfg),
